...
def build_camera_matrix(provider, pose_t):
    ...
    rgb_camera_calibration = calibration.get_linear_camera_calibration(480, 640, 133.25430222 * 2, rgb_stream_label,
...
def undistort_to_linear(provider, stream_ids, raw_image, camera_label='rgb'):
    ...
    warped = calibration.get_linear_camera_calibration(480, 640, 133.25430222 * 2, camera_label, 
                                                       calib.get_transform_device_camera())
...
def reproject_point(pose, provider=base_provider):
    ...
    warped = calibration.get_linear_camera_calibration(480, 640, 133.25430222 * 2, "rgb", 
                                                       calib.get_transform_device_camera())
...
def slam_to_rgb(provider=base_provider):
    ...
    slam_camera = calibration.get_linear_camera_calibration(480, 640, 133.24530222 * 2, slam_label, slam_calib.get_transform_device_camera())
    T_device_slam_camera = slam_camera.get_transform_device_camera()# slam to device frame
    ...
    rgb_camera = calibration.get_linear_camera_calibration(480, 640, 133.24530222 * 2, rgb_label, rgb_calib.get_transform_device_camera())
    T_device_rgb_camera = rgb_camera.get_transform_device_camera() # rgb to device frame
