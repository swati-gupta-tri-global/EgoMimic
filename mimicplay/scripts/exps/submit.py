...
if __name__ == "__main__":
    ...
    log_folder = f"/coc/flash7/rpunamiya6/EgoPlay/mimicplay/scripts/exps/{args.name}/%j"
    ...
    executor.update_parameters(slurm_partition="rl2-lab", cpus_per_task=14, nodes=1, slurm_ntasks_per_node=1, gpus_per_node="a40:1", slurm_qos="short", slurm_mem_per_gpu="40G", timeout_min=60*24*2)
