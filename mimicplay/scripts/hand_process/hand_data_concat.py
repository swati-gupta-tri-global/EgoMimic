                ...
                try:
                    with h5py.File(os.path.join(source, file), "r") as target:
                        try:
                            ...
                            target.copy(
                                target["data/demo_0/actions"],
                                dataset[f"data/{demo_group}"],
                            )
                            target.copy(
                                target["data/demo_0/obs"], dataset[f"data/{demo_group}"]
                            )
...
source = "/coc/flash7/datasets/egoplay/hand_data_robo_cam_jun3/v3h5Files"
destination = (
    "/coc/flash7/datasets/egoplay/hand_data_robo_cam_jun3/hand_data_robo_cam_jun3.hdf5"
)
