        ...
        for demo_name in demo_name_list:
            ...
            with torch.no_grad():
                ...
                while num_images > 0:
                    ...
                    if vis and webcam_num == -1:
                        result_path = os.path.join(
                            demo_dir, imglist[num_images][:-4] + "_det.png"
                        )
                ...
                clip.write_videofile(
                    os.path.join(demo_dir, "vis_{}.mp4".format(front_image_index)),
                    fps=8,
                )
                if webcam_num >= 0:
                    cap.release()
                ...
                ep_data_grp.create_dataset(
                    "hand_loc_{}".format(front_image_index), data=hand_loc
                )
                ...
                ep_data_grp.create_dataset(
                    "hand_act_{}".format(front_image_index), data=hand_act
                )
